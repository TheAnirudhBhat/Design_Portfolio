export const projects = [
  {
    id: "lens",
    title: "LENS",
    subtitle: "A schema-driven detail page framework that gave structure to credit card management and reduced cognitive load for users.",
    role: "Lead Product Designer · MobiKwik",
  ...
  },
  {
    ...
    role: "Product Designer · slice",
    href: "https://medium.com/@coolanirudh/epfo-a-product-design-case-study-45dbfbb93885",
    accent: "#2196F3",
...
export const BARCODE_WIDTHS = [3,1.5,3,1.5,3,3,1.5,3,1.5,1.5,3,1.5,3,3,1.5,1.5,3,3,1.5,3,1.5,1.5,3,3,1.5,3,1.5,3];
