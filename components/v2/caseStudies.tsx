...
export function MediumCta({ url }: { url: string }) {
  return (
    <a
      href={url}
      target="_blank"
...
function Cover({ id, fallback }: { id: string; fallback?: string }) {
...
export function LensCaseStudyContent() {
  return (
    <>
      <Cover id="lens" fallback="https://images.unsplash.com/photo-1563013544-824ae1b704d3?w=1600&auto=format&fit=crop" />
...
export function UpiCaseStudyContent() {
  return (
    <>
      <Cover id="upi-onboarding" />
      <article className="v2-case">
        <header className="v2-case-hero">
...
export function EpfoCaseStudyContent() {
  const project = getProject("epfo");
  return (
    <>
      <Cover id="epfo" />
      <article className="v2-case">
...
export function XtraCaseStudyContent() {
  return (
    <>
      <Cover id="xtra" />
      <article className="v2-case">
...
export const caseContentById: Record<string, () => React.ReactElement> = {
  lens: LensCaseStudyContent,
  "upi-onboarding": UpiCaseStudyContent,
  epfo: EpfoCaseStudyContent,
  xtra: XtraCaseStudyContent,
};
