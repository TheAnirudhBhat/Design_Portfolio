    ...
    <section className="mx-auto max-w-6xl px-6 py-32">
      ...
      <div className="mt-10 flex flex-wrap items-center gap-8">
        <MagneticButton
          ...
          className="text-lg font-medium text-dw-accent underline underline-offset-4 decoration-dw-accent/30 hover:decoration-dw-accent transition-colors duration-300"
        >
      ...
      <div className="mt-20 border-t border-white/5 pt-6">
        <p className="text-xs text-dw-muted/50">
